...
public class QRsolution {
    ...
    public void solve_qr_b_givenrotation(Matrix a) {
        wmtx = a.copy();
    ...
    public void solve_qr_b_householder(Matrix a) {
        wmtx = a.copy();
        col = a.getColumnDimension();
        row = a.getRowDimension();
        b = a.getColumn(col - 1);
        ...
        amtx = new Matrix(a1);
        QRdecomposition col = new QRdecomposition();
        col.qr_fact_househ(amtx);
        qmtx = col.getQMatrix();
        rmtx = col.getQMatrix();
    }
